...
$name_rsc = mysqli_query($koneksi, "SELECT * FROM accounts WHERE id='$id_to_delete'");
$name_to_delete = mysqli_fetch_array($name_rsc)['username'];

if(is_dir('../account/'.$name_to_delete)){
	rmdir('../account/'.$name_to_delete);
}
